...
* You have gone through https://docs.killbill.io/latest/install-kb_and_kaui.html[Install Kill Bill and Kaui] and installed all three
* You have gone through https://docs.killbill.io/latest/set_up_kb_using_kaui.html[Set Up Kill Bill Using Kaui] OR https://docs.killbill.io/latest/set_up_kb_with_the_API.html[Set Up Kill Bill Using the API] and have Kill Bill, Kaui, and the database set up and running 
