...
* You have gone through the https://docs.killbill.io/latest/getting_started.html[Getting started] tutorial and have MySQL, Kill Bill and Kaui setup and running in Docker containers
