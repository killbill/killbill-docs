...
Along with the user's payment method details, a client application also needs to send the plugin name to the addPaymentMethod method. This helps Kill Bill to route the payment processing to the appropriate plugin
