...
This section focuses on writing your own plugins. Check our http://killbill.io/userguide/platform-userguide/[deployment guide] for tips on how to deploy them.
