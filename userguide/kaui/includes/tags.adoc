...
image::../assets/image/kaui/TagDropdown-TagDef.png[width=150,align="center"]

Kaui displays the Tag Definitions page.

image::../assets/image/kaui/TagDefinitionsPage.png[width=850,align="center"]
...
image::../assets/image/kaui/TagDropdown-Tags.png[width=150,align="center"]

Kaui displays the Tags page.

image::../assets/image/kaui/TagsPage-All.png[width=850,align="center"]
...
image::../assets/image/kaui/TagsPage.png[width=850,align="center"]
...
image::../assets/image/kaui/TagDefinitionsPage.png[width=850,align="center"]
+
. Next to *Tag Definitions*, click the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ).
+
Kaui displays the Add New Tag Definition screen:
+
image::../assets/image/kaui/AddTagDefinition.png[width=350,align="center"]
+
. Fill in the fields:

* *Object type*—The type of object that the tag can be attached to (for example, accounts). To allow this tag to be applied to other object types, click the plus sign icon ( image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Object type*.
...
+
image::../assets/image/kaui/TagDefinition-AfterCreate.png[width=850,align="center"]
...
. Click the tag icon:
+
image::../assets/image/kaui/Account-ShowTags.png[width=350,align="center"]
+
