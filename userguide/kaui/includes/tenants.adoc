...
The tabs at the bottom of the screen allow you to configure various aspects of the system, such as the catalog, overdue actions, invoices, and plugin configuration.
