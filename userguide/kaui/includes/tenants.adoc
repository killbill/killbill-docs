...
The Overdue tab is applicable if you have configured overdue (dunning) actions for the current tenant in your Kill Bill system. On this tab, you can
...
a| * <<View Overdue Actions,View overdue actions>>
* <<Define Overdue Actions,Defineoverdue actions>>
* <<Upload an Overdue Configuration File,Upload an overdue configuration file>>

a| * <<View Overdue Actions as XML,View overdue actions as XML>>
* <<Delete Overdue Actions,Delete overdue actions>>
...
[NOTE]
*Note 2:* As opposed configuring overdue actions for a tenant, you can configure overdue actions for the global Kill Bill system. For more information, see the https://docs.killbill.io/latest/overdue.html[_Overdue System_] documentation.
...
* https://docs.killbill.io/latest/overdue.html[Overdue System]
...
Kaui displays the Tenant Configuration page.
+
. Scroll down until you see the Overdue Show tab:
+
image::Catalog-Tabs-Overdue.png[width=850,align="center"]

==== Define Overdue Actions
...
+
Fill in the field. For field information, see the <<Overdue Configuration Field Descriptions>> table.
+
. Click the *Save* button. Kaui displays the new action on the Overdue Show tab
+
SCREENSHOT
...
==== Upload an XML Overdue File

==== View Overdue Settings as XML
