...
. At the top of the screen, click the gears icon ( image:../assets/image/kaui/i_gears.png[] ) and select *Tenants*.
+
image::../assets/image/kaui/Homepage-SelectGears.png[width=650,align="center"]
+
Kaui displays a list of tenants on the Tenants screen:
+
image::../assets/image/kaui/TenantsList.png[width=850,align="center"]
+
. Click the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Kaui Tenants*.
+
Kaui displays the Add New Tenant screen:
+
image::../assets/image/kaui/AddNewTenant.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/TenantConfig-TenantName.png[width=850,align="center"]

=== Tenant Configuration Page

This section explains the main areas of the Tenant Configuration page.

image::../assets/image/kaui/TenantConfig-Labeled.png[width=850,align="center"]
...
This section displays the users who have permission to log on to this tenant. You can click on the user name to view that users's details or click on the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ) to add a new user for the current tenant.
...
+
. To the right of *Allowed Users*, click the plus icon ( image:../assets/image/kaui/i_PlusGreen.png[] ).
+
image::../assets/image/kaui/UserTenantScreen2.png[width=850,align="center"]
+
Kaui displays the Add Allowed User pop-up.
+
image::../assets/image/kaui/AddAllowedUser.png[width=350,align="center"]
...
+
image::../assets/image/kaui/UserTenantScreen3.png[width=850,align="center"]
+
