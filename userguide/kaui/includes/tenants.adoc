...
+
Once you have selected it, Kaui displays the filename next to the *Choose File* button.
+
image::../assets/img/kaui/Catalog-AdvancedConfigUpload-File.png[width=450,align="center"]
+
. Click the *Upload* button. GOT AN ERROR HERE
+
Kaui displays (something or other):
+
SCREENSHOT
...
+
image::../assets/img/kaui/Catalog-RawXML.png[width=450,align="center"]
+
...
_I'm not sure if this is available (or how it works) after you've uploaded a specific catalog (i.e., a non-simple catalog). Maybe it's only available for the simple catalog functionality?_
...
+
image::../assets/img/kaui/Catalog-AddPlanCurrency.png[width=650,align="center"]
. Fill in the fields:
...
* *Currency*—The currency you are adding. Kaui displays options based on

==== Download the Catalog

The steps below explain how to download the current catalog for Kill Bill.
