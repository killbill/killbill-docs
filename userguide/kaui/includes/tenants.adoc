...
* <<translation-files,Invoice Template>>—Upload invoice template files.

* <<translation-files,Invoice Translation>>—Upload translated invoice files.

* <<translation-files,Catalog Translation>>—Upload translated catalog strings files.

* *Plugin Config*—Upload plugin configuration files. _Currently undocumented._

=== Add an Allowed User to the Tenant

The steps below explain how to add an _existing_ user to the current tenant. Before you begin, you should have created the user in the Kill Bill system by following the steps in the <<Add a User>> section.
