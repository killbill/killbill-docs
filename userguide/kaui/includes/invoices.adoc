...
+
image::../assets/img/kaui/Invoice-DryRunBox.png[width=450,align="center"]
+
. In the field next to *Dry-run*, enter the date that matches the invoice's upcoming invoice date.
+
image::../assets/img/kaui/Invoice-NextBillDate.png[width=450,align="center"]
+
. Click the magic wand button:
+
image::../assets/img/kaui/i_InvoiceGen.png[align="left"]
+
