...
+
. Hover over the tag icon (image:../assets/image/kaui/i_Tag.png[]). Kaui displays a drop-down:
+
...
+
. Hover over the trashcan icon ( image:../assets/image/kaui/i_trash.png[] ). Kaui displays a drop-down:
+
