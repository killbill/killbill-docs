...
image::TranslationFilesTabs.png[width=850,align="center"]
...
+
image::Translation-UploadInvTemplate.png[width=350,align="center"]
+
...
+
image::Translation-UploadInvTemplate-Manual.png[width=350,align="center"]
+
...
+
image::Translation-UploadInvTransFile.png[width=850,align="center"]

. Click the *Upload* button.
+
If the upload is successful, Kaui displays a success message at the top of the screen and lists the file on the tab.
^^_I'm assuming this is what happens, but I received a Cloudflare error when I tried to upload._
