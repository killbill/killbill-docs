...
+
. _For Invoice Templates only:_ If this invoice template supports the manual pay option (for accounts that have the `MANUAL_PAY` tag), select the *Manual Pay* checkbox. (For more information, see the https://apidocs.killbill.io/#invoice-template["Templates"] section of the API.)
+
