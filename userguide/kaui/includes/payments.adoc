...
image::../assets/image/kaui/Payments.png[width=850,align="center"]
...
image::../assets/image/kaui/PaymentDetails.png[width=850,align="center"]
...
+
image::../assets/image/kaui/PaymentDetails2.png[width=850,align="center"]
+
. Hover over the credit card icon and select *Refund*.
+
image::../assets/image/kaui/PaymentDetail-SelectRefund.png[width=350,align="center"]
+
Kaui opens the Process Refund screen.
+
image::../assets/image/kaui/ProcessRefundPopup.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/PaymentDetails-Refund-Labeled.png[width=850,align="center"]
...
. <<Open Payment Details, Open the Payment Detail page>> for the payment.
+
image::../assets/image/kaui/PaymentDetails3.png[width=850,align="center"]
+
. Hover over the credit card icon and select *Chargeback*.
+
image::../assets/image/kaui/PaymentDetail-SelectChargeback.png[width=350,align="center"]
+
Kaui opens the Process Chargeback screen with the *Amount* and *Reason* fields already filled in.
+
image::../assets/image/kaui/ProcessChargeback.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/PaymentDetails-Chargeback-Labeled.png[width=850,align="center"]
