...
images::../assets/img/kaui/Payments.png[width=850,align="center"]
...
images::../assets/img/kaui/PaymentDetails.png[width=850,align="center"]
...
+
images::../assets/img/kaui/PaymentDetails2.png[width=850,align="center"]
+
. Hover over the credit card icon and select *Refund*.
+
images::../assets/img/kaui/PaymentDetail-SelectRefund.png[width=350,align="center"]
+
Kaui opens the Process Refund screen.
+
images::../assets/img/kaui/ProcessRefundPopup.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/PaymentDetails-Refund-Labeled.png[width=850,align="center"]
...
. <<Open Payment Details, Open the Payment Detail page>> for the payment.
+
images::../assets/img/kaui/PaymentDetails3.png[width=850,align="center"]
+
. Hover over the credit card icon and select *Chargeback*.
+
images::../assets/img/kaui/PaymentDetail-SelectChargeback.png[width=350,align="center"]
+
Kaui opens the Process Chargeback screen with the *Amount* and *Reason* fields already filled in.
+
images::../assets/img/kaui/ProcessChargeback.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/PaymentDetails-Chargeback-Labeled.png[width=850,align="center"]
