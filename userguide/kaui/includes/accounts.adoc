...
<<includes/navigate-and-interface.adoc#_basic_search,Basic Search>>
<<includes/navigate-and-interface.adoc#_advanced_search,Advanced Search>>
...
For more information on payment methods, see the <<Payment Methods>> section.
...
For more information on Tags, including a list of default tags, see the https://killbill.github.io/slate/#account-tags["Tags" section] in the https://killbill.github.io/slate/[_REST API Reference Manual_].
