...
* <<set-a-payment-method-as-the-default, Set a payment method as default>>
* <<delete-payment-method, Delete a payment method>>
* <<apply-a-transaction-to-a-payment-method, Apply a transaction to a payment method (authorize, charge, credit, etc.)>>
