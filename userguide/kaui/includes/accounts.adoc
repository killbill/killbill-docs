...
image::../assets/image/kaui/../assets/image/kaui/AccountPage_Labeled.png[width=850,align="center"]

*1. Account Sub-Menu*

The *Account* sub-menu organizes and provides access to different areas of the customer's account:

image::../assets/image/kaui/../assets/image/kaui/Account-Submenu.png[width=650,align="center"]
...
+
image::../assets/image/kaui/../assets/image/kaui/CreateNewAccount-Labeled.png[width=650,align="center"]
+
. Kaui opens the Add New Account screen:
+
image::../assets/image/kaui/../assets/image/kaui/AddNewAccount.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/../assets/image/kaui/Account_UpdateScreen.png[width=450,align="center"]
+
...
. Open the account on the Account page.
. In the Personal Information section, click the gray down arrow ( image:../assets/image/kaui/i_GrayDownArrow.png[] ) to expand the section.
+
image::../assets/image/kaui/../assets/image/kaui/PersonalInformation.png[width=450,align="center"]
+
. Click the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Contact emails*.
+
Kaui opens the Add New Email screen:
+
image::../assets/image/kaui/../assets/image/kaui/AddNewEmail.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/../assets/image/kaui/NewContactEmail.png[width=450,align="center"]
+
...
. Open the account on the Account page.
. In the Personal Information section, click the gray down arrow ( image:../assets/image/kaui/i_GrayDownArrow.png[] ) to expand the section.
. Next to the email you want to delete, click the red X ( image:../assets/image/kaui/i_RedX.png[] ). Kaui immediately deletes the email address.
...
+
image::../assets/image/kaui/../assets/image/kaui/CloseAccountPopup.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/../assets/image/kaui/AccountSubmenu-Closed.png[width=650,align="center"]
...
. In the Account Information section of the child account, click the plus sign icon (image:../assets/image/kaui/i_PlusGreen.png[]) next to the *Parent* field:
+
image::../assets/image/kaui/../assets/image/kaui/Account-ParentField-Labeled.png[width=450,align="center"]
+
Kaui opens a pop-up:
+
image::../assets/image/kaui/../assets/image/kaui/LinkToParentPopup.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/../assets/image/kaui/Account-ParentID-Labeled.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/../assets/image/kaui/AddCredit-Labeled.png[width=450,align="center"]
+
Kaui opens the *Add New Credit* screen:
+
image::../assets/image/kaui/../assets/image/kaui/AddCreditPopup.png[width=450,align="center"]
+
. Fill in the fields:
+
...
+
image::../assets/image/kaui/../assets/image/kaui/CreateCharge-Labeled.png[width=450,align="center"]
+
Kaui opens the *Add New Charge* screen:
+
image::../assets/image/kaui/../assets/image/kaui/AddNewChargePopup.png[width=450,align="center"]
+
