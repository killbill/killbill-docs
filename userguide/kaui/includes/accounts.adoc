...
image::../assets/image/kaui/AccountPage_Labeled.png[width=850,align="center"]

*1. Account Sub-Menu*

The *Account* sub-menu organizes and provides access to different areas of the customer's account:

image::../assets/image/kaui/Account-Submenu.png[width=650,align="center"]
...
+
image::../assets/image/kaui/CreateNewAccount-Labeled.png[width=650,align="center"]
+
. Kaui opens the Add New Account screen:
+
image::../assets/image/kaui/AddNewAccount.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/Account_UpdateScreen.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/PersonalInformation.png[width=450,align="center"]
+
. Click the plus sign ( image:i_PlusGreen.png[] ) next to *Contact emails*.
+
Kaui opens the Add New Email screen:
+
image::../assets/image/kaui/AddNewEmail.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/NewContactEmail.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/CloseAccountPopup.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/AccountSubmenu-Closed.png[width=650,align="center"]
...
+
image::../assets/image/kaui/Account-ParentField-Labeled.png[width=450,align="center"]
+
Kaui opens a pop-up:
+
image::../assets/image/kaui/LinkToParentPopup.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/Account-ParentID-Labeled.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/AddCredit-Labeled.png[width=450,align="center"]
+
Kaui opens the *Add New Credit* screen:
+
image::../assets/image/kaui/AddCreditPopup.png[width=450,align="center"]
+
. Fill in the fields:
+
...
+
image::../assets/image/kaui/CreateCharge-Labeled.png[width=450,align="center"]
+
Kaui opens the *Add New Charge* screen:
+
image::../assets/image/kaui/AddNewChargePopup.png[width=450,align="center"]
+
