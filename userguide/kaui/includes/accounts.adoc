...
images::../assets/img/kaui/AccountPage_Labeled.png[]

*1. Account Sub-Menu*

The *Account* sub-menu organizes and provides access to different areas of the customer's account:

images::../assets/img/kaui/Account-Submenu.png[width=650,align="center"]
...
+
images::../assets/img/kaui/CreateNewAccount-Labeled.png[width=650,align="center"]
+
. Kaui opens the Add New Account screen:
+
images::../assets/img/kaui/AddNewAccount.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/Account_UpdateScreen.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/PersonalInformation.png[width=450,align="center"]
+
. Click the plus sign ( image:i_PlusGreen.png[] ) next to *Contact emails*.
+
Kaui opens the Add New Email screen:
+
images::../assets/img/kaui/AddNewEmail.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/NewContactEmail.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/CloseAccountPopup.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/AccountSubmenu-Closed.png[width=650,align="center"]
...
+
images::../assets/img/kaui/Account-ParentField-Labeled.png[width=450,align="center"]
+
Kaui opens a pop-up:
+
images::../assets/img/kaui/LinkToParentPopup.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/Account-ParentID-Labeled.png[width=450,align="center"]
+
...
+
images::../assets/img/kaui/AddCredit-Labeled.png[width=450,align="center"]
+
Kaui opens the *Add New Credit* screen:
+
images::../assets/img/kaui/AddCreditPopup.png[width=450,align="center"]
+
. Fill in the fields:
+
...
+
images::../assets/img/kaui/CreateCharge-Labeled.png[width=450,align="center"]
+
Kaui opens the *Add New Charge* screen:
+
images::../assets/img/kaui/AddNewChargePopup.png[width=450,align="center"]
+
