...
+
image::../assets/image/kaui/Users-SelectTenantName.png[width=650,align="center"]
+
Kaui displays the Tenant Configuration page.
+
. Scroll down and click on the Overdue Show tab:
+
image::../assets/image/kaui/OverdueTab.png[width=850,align="center"]
...
image::../assets/image/kaui/OverdueTab.png[width=850,align="center"]
+
. Click the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Existing Overdue Config*.
+
Kaui opens the Overdue Configuration screen:
+
image::../assets/image/kaui/OverdueConfig-Empty.png[width=850,align="center"]
+
. Click *+ New Overdue States*. Kaui opens the fields for editing:
+
image::../assets/image/kaui/OverdueConfig-BlankFields.png[width=850,align="center"]
+
...
+
image::../assets/image/kaui/Overdue-Select-NewOverdueState.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/Overdue-ShowFlows.png[width=850,align="center"]

[NOTE]
*Note:* To edit an existing overdue flow, on the Overdue Show tab, click the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Existing Overdue Config*. This opens the overdue configuration fields in edit mode.
...
+
image::../assets/image/kaui/Overdue-AdvancedConfigUpload.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/Overdue-AdvancedConfigUpload-File.png[width=450,align="center"]
+
...
+
image::../assets/image/kaui/Overdue-ShowUpload.png[width=850,align="center"]
...
image::../assets/image/kaui/OverdueTab.png[width=850,align="center"]
+
. Click *View Overdue XML* to the right of the plus sign ( image:../assets/image/kaui/i_PlusGreen.png[] ). Kaui displays the raw XML (uneditable in this view).
+
...
Kaui opens the Overdue Configuration screen.
+
. Click the red X ( image:../assets/image/kaui/i_RedX.png[] ) to the right of every configuration row you want to delete.
+
image::../assets/image/kaui/Overdue-Select-Delete.png[width=850,align="center"]
+
