...
+
image::../assets/img/kaui/SelectCancelSubscription.png[width=250,align="center"]
+
Kaui displays several options. The option you select defines how Kill Bill handles billing for the canceled subscription:
+
image::../assets/img/kaui/Subscriptions-CancelOptions.png[width=350,align="center"]
...
+
image::../assets/img/kaui/SelectUpdateBCD.png[width=250,align="center"]
+
