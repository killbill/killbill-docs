...
* API Reference for https://apidocs.killbill.io/#custom-field[Custom Field]
* "Custom Fields" section for object types in the https://apidocs.killbill.io/[API Reference]
