...
image::../assets/image/kaui/TagDropdown-CustomFields.png[width=150,align="center"]

Kaui displays the Custom Fields page:

image::../assets/image/kaui/CustomFields-More.png[width=850,align="center"]
...
image::../assets/image/kaui/CustomFields-Specific.png[width=850,align="center"]
...
+
image::../assets/image/kaui/CustomFields-Populated.png[width=850,align="center"]
+
. Click the plus sign (image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Custom Fields.*
+
Kaui displays the Add New Custom Field screen:
+
image::../assets/image/kaui/AddNewCustomField.png[width=350,align="center"]
+
