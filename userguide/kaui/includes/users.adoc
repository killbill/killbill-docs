...
+
image::../assets/image/kaui/AddNewRole.png[width=450,align="center"]
+
...
At the top of the screen, click the gears icon ( image:../assets/image/kaui/i_gears.png[]) and select *Users*.

image::../assets/image/kaui/Homepage-SelectGears.png[width=650,align="center"]

Kaui displays the Users screen:

image::../assets/image/kaui/UsersList3.png[width=650,align="center"]
...
+
. Select the plus icon ( image:../assets/image/kaui/i_PlusGreen.png[] ) next to *Kaui Users*.
+
Kaui displays the Add New User pop-up:
+
image::../assets/image/kaui/AddNewUser.png[width=550,align="center"]
+
...
+
image::../assets/image/kaui/ConfiguredTenants3.png[width=550,align="center"]
+
...
+
image::../assets/image/kaui/ConfiguredTenants2.png[width=850,align="center"]
+
...
+
image::../assets/image/kaui/UpdateUser.png[width=450,align="center"]
+
. Fill in the user fields. For field descriptions, see <<Add New User Field Descriptions>>.
. Click the *Save* button.
...
image::../assets/image/kaui/ConfiguredTenants2.png[width=850,align="center"]
+
. Click the image:../assets/image/kaui/i_RedX.png[] icon. Kaui displays a message to confirm the deletion.
+
. Click *OK*.
+
