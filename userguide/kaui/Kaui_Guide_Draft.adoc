...
Kaui opens the *Add New Credit* pop-up:
...
=== Payments Page
The Payments page lists any payments applied to the account. These are payments made against an invoice or against a charge.
...
On the Payment Details page, you can: refund the payment or perform a chargeback.
...
1. Open an account.
2. Click on the *Payments* submenu.
...
//What is the difference between refunding a payment from the Payment Details page and refunding directly to the payment instrument (like a credit card)?

To refund a specific payment:

1. Open the Payment Detail page for the payment.
...
Kaui opens the Process Refund pop-up:
