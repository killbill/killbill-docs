...
The https://docs.killbill.io/latest/userguide_subscription.html#_billing_alignment_rules["Billing Alignment Rules"] specify whether billing occurs at the account/subscription level or bundle level.

[NOTE]
*Note:* If you update a subscription BCD in Kaui, this BCD overrides what is specified in the billing alignment rules in the catalog.
