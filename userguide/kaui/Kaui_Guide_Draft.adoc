...
For information on how changing the BCD affects the subscription, see https://docs.killbill.io/latest/userguide_subscription.html#_billing_alignment_rules["Billing Alignment Rules"] in the __Subscription Guide__.
