...
**Assumptions**: We assume the reader went through the tutorials listed under the https://docs.killbill.io/latest/install-kb_and_kaui.html["Getting Started"] section of the documentation and has a running system (both killbill and kaui) running on IP=`127.0.0.1`.
