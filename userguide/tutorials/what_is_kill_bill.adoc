...
Kill Bill is a mature project which powers the billing and payment infrastructure of some of the largest e-commerce websites.

image:https://github.com/killbill/killbill-docs/raw/landing-page/userguide/assets/img/logos/mosaique.png[align=center]

[quote, Galen P., Chief Technology Officer (Real Estate company with 1-10 employees)]
...
[quote, Chris Z, Tech Lead (Computer Software company 1001-5000 employees)]
Kill Bill offers a powerful platform we will use to manage the complexity of subscription billing, which will allow us to release features faster with fewer bugs.

[quote, Dave O., Engineering Manager (Insurance company with 5001-10000 employees)]
Easy to get setup and running. We did not have to build our own billing engine or buy a commercial one.
