...
* _Multi-tenancy_: Kill Bill has been designed as a multi-tenant system, meaning **you can run multiple logical instances of Kill Bill with a single server and database**. (See this http://killbill.io/blog/subscription-service-using-kill-bill[blog post], which illustrates some of the use cases.)
* Plugins
...
1. Follow the tutorials listed under the https://docs.killbill.io/latest/install-kb_and_kaui.html["Getting Started"] section of the documentation.
