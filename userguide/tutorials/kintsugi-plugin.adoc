...
link:userguide_configuration.html#global_configuration_properties[Kill Bill Configuration File],
or at a link:userguide_configuration.html#per_tenant_properties[per-tenant level]:
...
Ensure that the plugin is installed as explained in the <<_plugin_installation, "Plugin Installation">> section.
