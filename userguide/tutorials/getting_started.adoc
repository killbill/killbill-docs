...
. Open a browser and type http://localhost:8080/kaui This should display the following sign in page: image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/img/kaui_sign_in.png[align=center]
