...
* Core services (account management, invoicing, entitlement, dunning, ...), each of which exposing its own APIs and publishing bus events, which are consumed by other core services or plugins
* Plugins
