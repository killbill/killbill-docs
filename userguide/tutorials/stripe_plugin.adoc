...
Ensure that you have Kill Bill, Kaui, and the database set up and running in Docker containers as explained in the tutorials listed under the https://docs.killbill.io/latest/install-kb_and_kaui.html["Getting Started"] section of the documentation.
...
Ensure that you have Kill Bill, Kaui, and the database set up in Tomcat as explained in the https://docs.killbill.io/latest/install-kb_and_kaui.html#_tomcat[Getting Started] document.
