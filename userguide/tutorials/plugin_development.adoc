...
* Packages exported by Kill Bill are automatically imported by a plugin. This is explained in the <<packages_imported_by_plugins_by_default, "Packages Imported by Plugins by Default">> section. 
