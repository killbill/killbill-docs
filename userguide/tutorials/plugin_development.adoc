...
3. Kill Bill broadcast the change across the cluster of nodes and emit an configuartion bus event: `TENANT_CONFIG_CHANGE` or `TENANT_CONFIG_DELETION`
...
TODO: explain merge between properyy file and per-tenant entries
