...
* You have the email notification plugin (version *0.7.0*) installed as explained in the https://docs.killbill.io/latest/email-notification-plugin.html[Email Notification Plugin] document.
