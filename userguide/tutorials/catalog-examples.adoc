...
In each section, subscriptions are created corresponding to the plans in the corresponding catalog. Invoices are generated via the Kaui invoice dry run feature. 
