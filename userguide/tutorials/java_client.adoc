...
* You have gone through the tutorials listed under the https://docs.killbill.io/latest/install-kb_and_kaui.html["Getting Started"] section of the documentation and have Kill Bill, Kaui and the database setup and running
