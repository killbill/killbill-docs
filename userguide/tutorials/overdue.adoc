...
* Ensure that you have configured Kill Bill, Kaui and the database as explained in the tutorials listed under the https://docs.killbill.io/latest/install-kb_and_kaui.html["Getting Started"] section of the documentation.
...
+
. Start Kill Bill Ensure either on https://docs.killbill.io/latest/install-kb_and_kaui.html#_aws_one_click[__AWS__], https://docs.killbill.io/latest/install-kb_and_kaui.html#_docker[__Docker__], https://docs.killbill.io/latest/install-kb_and_kaui.html#_tomcat[__Tomcat__] or in  https://docs.killbill.io/latest/development.html#_running_the_application[__standalone__] mode.
+
