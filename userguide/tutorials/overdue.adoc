...
[source, xml]
<state name="WARNING">  
|condition     |Tag within `state` |Specifies the condition to be evaluated. See <<Overdue Conditions>>. The account will enter this overdue state only if the condition evaluates to true.  | See <<Overdue Conditions>>
