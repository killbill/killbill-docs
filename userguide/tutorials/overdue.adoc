...
* Ensure that you have configured Kill Bill, Kaui and the database as explained in the http://docs.killbill.io/latest/getting_started.html[_Getting Started_] document.
...
The plugin can be installed using any of the methods specified in the https://docs.killbill.io/latest/plugin_development.html#_plugin_installation[__Plugin Installation Instructions__].
