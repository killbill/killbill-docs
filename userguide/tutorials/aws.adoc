...
image:../assets/aws/std-enable-public-ip.png[align=center]

* Make sure you open the ingress port `443`, and `8443` on your security group:

image:../assets/aws/std-security-group.png[align=center]

* Make sure you specify an existing known key-pair (for SHH access)

image:../assets/aws/std-key-pair.png[align=center]
