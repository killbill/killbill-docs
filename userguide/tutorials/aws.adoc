...
1. Start the installation process by going to link:++https://aws.amazon.com/marketplace/pp/prodview-nochv5omslmds?ref=_ptnr_doc_++[AWS Marketplace]: click *Continue to Subscribe* and populate the configuration options in the CloudFormation form.
2. Launch the stack.
