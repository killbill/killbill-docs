...
For secure and private communication we recommend the use of HTTPS. For general information about HTTPS and how to create a certificate see xxx. If you don't already have a certificate we recommend creating one via the Amazon Certificate Manager (ACM).
