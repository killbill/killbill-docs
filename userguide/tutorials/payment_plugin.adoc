...
. Write code within your class for all the methods in the `PaymentPluginApi` interface. You can refer to our https://github.com/killbill/killbill-stripe-plugin/blob/657482f82949f08d4d317be8eb159855e7aad6f7/src/main/java/org/killbill/billing/plugin/stripe/StripePaymentPluginApi.java[StripePluginApi] or https://github.com/killbill/killbill-adyen-plugin/blob/0c5205d2ee42b543852e7cbd1a6f6f065ad575e5/src/main/java/org/killbill/billing/plugin/adyen/api/AdyenPaymentPluginApi.java[AdyenPaymentPluginApi] if required.
