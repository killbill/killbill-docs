...
//https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/img/payment-plugin/How-Go-Cardless-Works.png[align=center]
...
image::../assets/img/payment-plugin/Using-GoCardless-From-KillBill.svg[width=1175,align=center]

//https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/img/payment-plugin/Using-GoCardless-From-KillBill.png[align=center]
