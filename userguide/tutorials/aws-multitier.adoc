...
image::../assets/aws/multi-tier-ami_deployment.svg[width=1300,align=center]

//https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/multi-tier-ami_deployment.png[align=center]
