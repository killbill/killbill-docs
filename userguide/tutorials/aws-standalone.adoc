...
DB_PROPS="/tmp/db.properties.$$"
KB_PROPS="/tmp/kb.properties.$$"

UPDATE_PROP_SCRIPT="/var/lib/tomcat/bin/updateProperties.sh"

function write_db_props() {
  cat <<_EOF > $DB_PROPS
#
# EDIT FOLLOWING DB PROPERTIES BELOW AS NEEDED
#
DB_SERVER="dbserver:3306"
DB_USER="myuser"
DB_PASSWORD="mypwd"
...
su -l -c "cd /var/lib/tomcat/bin && $UPDATE_PROP_SCRIPT $DB_PROPS $KB_PROPS" tomcat
```
