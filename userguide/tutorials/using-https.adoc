...
If you own a domain, your domain provider can serve as your CA. If you don't have a domain, you can purchase one for very low cost from a domain provider such as Godaddy. When you obtain a domain you need to prove your identity, so your domain provider must trust you. To demonstrate this trust you will need a CNAME.

== CNAMEs

A CNAME, or *Canonical Name*, is an identifier that links your CA to one or more resources that you are protecting with your certificate.
...
1. Using a free CA (such as *Let's Encrypt*)
