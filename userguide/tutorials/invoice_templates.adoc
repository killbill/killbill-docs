...
## Customizing Invoice Template, Translations & Branding Directly
...
### Uploading Invoice Translations
...
### Uploading Catalog Translations

//TODO - Add a note about what catalog translations are, how they are different from invoice translations and that they are optional
