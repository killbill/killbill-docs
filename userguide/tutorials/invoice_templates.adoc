...
* https://apidocs.killbill.io/#invoice-translation[_Invoice Translation Slate Documentation_]

* https://apidocs.killbill.io/#invoice-render-an-invoice-as-html[_Invoice Generation Slate Documentation_]
