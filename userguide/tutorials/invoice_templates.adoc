...
[start=2]
a. Upload the file via the following `cURL` command:
...
[start=3]
a. Alternatively, you can upload this file via Kaui by going to your admin tenant page (`InvoiceTemplate`) tab:
...
[start=2]
1. Upload the invoice translation for the desired locale. For instance, in order to upload the translation for the locale `fr_FR`:
...
[start=3]
a. Alternatively, you can upload this file via Kaui by going to your admin tenant page (`InvoiceTranslation`) tab:
...
1. In addition to the invoice template translation, you can also upload a catalog translation file. 
...
[start=3]
a. Alternatively, you can upload this file via Kaui by going to your admin tenant page (`CatalogTranslation`) tab:
...
[start=2]
a. Alternatively, you can generate the HTML invoice via `Invoices` tab in Kaui:
