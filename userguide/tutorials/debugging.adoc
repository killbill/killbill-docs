...
In case of a https://docs.killbill.io/latest/install-kb_and_kaui.html#_tomcat[Tomcat installation], the `kpm diagnostic` command can be run as follows:
...
If you are using a https://docs.killbill.io/latest/install-kb_and_kaui.html#_docker[Docker installation], you can simply run the following command in the Kill Bill container:
...
If you are using an https://docs.killbill.io/latest/install-kb_and_kaui.html#_aws_one_click[AWS installation], you can run the `kpm diagnostic` command as specified https://docs.killbill.io/latest/aws-singletier.html#_diagnostic_command[here].
