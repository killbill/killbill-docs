...
* You have gone through the https://docs.killbill.io/latest/install-kb_and_kaui.html[Getting started] tutorial and have Kill Bill, Kaui and the database setup and running
