...
* You have gone through the https://docs.killbill.io/latest/getting-started.html[Getting started] tutorial and have Kill Bill, Kaui and the database setup and running
