...
For an introduction to KAUI, see our https://docs.killbill.io/latest/getting_started.html#_using_kill_bill_with_kaui[Getting Started] guide.
...
3. Provide a for the administrative acount (we suggest you let AWS generate one for you)
