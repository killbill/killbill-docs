...
The first step is to setup the RDS instance. This process begins with the RDS dashboard, which is distinct from the EC2 dashboard. Open the dashboard, select `Databases` from the left menu, and click the red button at the top right that reads `Create Database`:

image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/create-database.png[align=center]
...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/standard-or-easy.png[align=center]
...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/database-types.png[align=center]
...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/instance-sizes.png[align=center]
...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/names-and-password.png[align=center]
...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/database-starting.png[align=center]
...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/aws/connectivity-and-security.png[align=center]
...
```
First, you need to edit the database properties. DB_SERVER should be set to the full name of the DB instance, as given in the `Connectivity and Security` panel (see above). DB_USER and DB_PASSWORD should be set to the administrator credentials you have chosen for the RDS instance.
...
[4] Install database schemas

To install the database schemas, you will need to `ssh` to one EC2 instance using your private key -- make sure you have alowed incoming SSH traffic on port `22` in your security group.
...
The procedure to install the schemas is:
