...
* Ensure that you have Kill Bill, Kaui, and the database set up as explained in the tutorials listed under the https://docs.killbill.io/latest/install-kb_and_kaui.html["Getting Started"] section of the documentation.
...
. Ensure that Kill Bill is running either in https://docs.killbill.io/latest/development.html#_running_the_application[_standalone_] mode or in https://docs.killbill.io/latest/install-kb_and_kaui.html[_Tomcat_].
