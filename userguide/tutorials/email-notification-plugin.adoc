...
The configuration can easily be done via the https://aviate.killbill.io/home[Aviate UI] by clicking the "Configuration" link in the Aviate left nav.
//TODO create a storylane demo and add a link here
