...
While your website will issue an API call to do it, let's simply use http://127.0.0.1:3000/accounts/new[Kaui] in this tutorial to create the account manually.
