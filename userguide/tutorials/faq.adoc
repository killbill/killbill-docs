...
See http://docs.killbill.io/latest/userguide_subscription.html#components-catalog-usage[our Usage documentation] to understand the various types of usage Kill Bill supports.
