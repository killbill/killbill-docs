...
Create your first tenant and a simple catalog by following the steps in the https://docs.killbill.io/latest/quick_start_with_kaui.html[_Quick Start with Kaui_] guide. 

You can also use the Kill Bill API to create an account, payment method, and subscription; see the https://docs.killbill.io/latest/quick_start_with_kb_api.html[_Quick Start with the Kill Bill API_] guide. Or, explore our full https://killbill.github.io/slate/[API documentation].
