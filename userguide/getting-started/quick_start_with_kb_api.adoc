...
. <<step2, Add a payment method to the account>>
. <<step3, Set up a subscription for the account>>
...
. Follow the _Quick Start with Kaui_ guide to https://docs.killbill.io/latest/quick_start_with_kaui.html#step1[create your first tenant] and a https://docs.killbill.io/latest/quick_start_with_kaui.html#step2[simple catalog].
...
[NOTE]
*Note:* You can view the invoice that is automatically generated by going to the account in Kaui and clicking the Invoices sub-menu. For more information, see https://docs.killbill.io/latest/quick_start_with_kaui.html#step6[View the Generated Invoice] in the _Quick Start with Kaui_ guide. 