...
* https://apidocs.killbill.io[_API Reference_]
...
For more information, see the https://apidocs.killbill.io/?java#tenant-create-a-tenant[Create a Tenant] endpoint.
...
For this tutorial, instead of starting with the XML catalog, you'll learn how to create a simple catalog using the API as well as adding one plan. You can find more information on the https://apidocs.killbill.io/#catalog-simple-plan[Simple Plan] endpoint in the API. 

[NOTE]
*Note:* The simple catalog supports a _subset_ of the regular XML catalog features and isn't intended to serve as a catalog in production. For more details on the simple catalog, see the https://apidocs.killbill.io/#catalog-simple-plan["Simple Plan"] section in the _API Reference_.
...
[NOTE]
*Note:* You can repeat this API call to create another plan. For more information, see https://apidocs.killbill.io/#catalog-simple-plan[Simple Plan] in the API.
...
For more information, see the https://apidocs.killbill.io/#account-create-an-account[Create an Account] endpoint.
...
For simplicity, we will create an offline payment method—checks—for the account we created in <<_step_1_create_a_tenant, Step 1>> using the https://apidocs.killbill.io/#account-add-a-payment-method[Add a Payment Method] endpoint.
...
You are now ready to create a https://docs.killbill.io/latest/Kill-Bill-Glossary.html#subscription[subscription^] for the customer. For this, we'll use the https://apidocs.killbill.io/#subscription-create-a-subscription[Create a Subscription] endpoint.
...
To view the invoice that Kill Bill automatically generated for the subscription in <<_step_5_set_up_a_subscription_for_the_account, Step 5>>, use the https://apidocs.killbill.io/?shell#account-retrieve-account-invoices[Retrieve Account Invoices] endpoint.
