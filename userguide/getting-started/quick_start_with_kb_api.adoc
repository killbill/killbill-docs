...
For simplicity, we will create an offline payment method—checks—for the account we created in <<step1, Step 1>> using the https://killbill.github.io/slate/#account-add-a-payment-method[Add a Payment Method] endpoint.
