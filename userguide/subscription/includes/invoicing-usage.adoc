...
Currently it is considered an error to have past usage data missing. In such a scenario, the system will `park` the account, that is, no move invoicing will happen on the account until the issue was fixed.
