...
image::../assets/img/subscriptions/catalog_pricelist.svg[width=500,float="right"]
...
image::../assets/img/subscriptions/catalog_cancellation_timing.svg[width=650,align="center"]
...
image::../assets/img/subscriptions/catalog_change_timing.svg[width=650,align="center"]
