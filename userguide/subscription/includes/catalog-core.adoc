...
image:https://github.com/killbill/killbill-docs/raw/v3/userguide/assets/img/catalog/effectiveDateForExistingSubscriptionsCropped.png[width=650,align="center"]
