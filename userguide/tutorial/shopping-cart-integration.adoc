...
On the PayPal site, the user will be guided through the approval process to create a recurring token for your website.

Once the customer comes back from the PayPal flow, save the token (also known as BAID, for Billing Agreement ID) in Kill Bill:
