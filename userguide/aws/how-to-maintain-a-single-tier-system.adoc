...
The system maintains a series of logfiles that may be helpful when troubleshooting is needed. These logs may be forwarded to Kill Bill to help diagnose your problem.
