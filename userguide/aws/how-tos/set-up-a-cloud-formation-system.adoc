...
Similarly, edit the second listener and change HTTP to HTTPS. Type 8443 as the port number, replacing 443. Be sure your certificate is selected at the bottom, and click **Save Changes**.
...
image::../../assets/aws/cf-new-inbound-rules.png[align=center]
