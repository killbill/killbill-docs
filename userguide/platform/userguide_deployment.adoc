...
Because a lot of pieces need to be in place, and because a lot can go wrong, users are *strongly* encouraged to use our pre-built https://registry.hub.docker.com/u/killbill/killbill[Docker images] and https://github.com/killbill/killbill-cloud/tree/master/docker[Docker Compose] recipes.

Experienced users can also opt for our https://github.com/killbill/killbill-cloud/tree/work-for-release-0.19.x[Ansible playbooks].
