...
Experienced users can also opt for our https://github.com/killbill/killbill-cloud/tree/work-for-release-0.19.x[Ansible playbooks] (Ansible is an open-source IT Automation tool), to install and configure [Apache Tomcat](https://tomcat.apache.org/), [KPM](https://github.com/killbill/killbill-cloud/tree/master/kpm) and Kill Bill individually.
...
Documentation for our images is available https://github.com/killbill/killbill-cloud/blob/master/docker/README.md[here]. Our http://killbill.io/blog/tag/docker/[blog] has also lots of tips on how to deploy to popular cloud providers. Our Docker Compose recipes work with all [Docker Machine supported platform](https://docs.docker.com/machine/drivers/).
