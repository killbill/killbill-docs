...
* Monitor your logs constantly: any `WARN` or `ERROR` entry should be reviewed, as well as stacktraces.
* Join our https://groups.google.com/forum/#!forum/killbilling-users[mailing-list] to get notified of new releases.
