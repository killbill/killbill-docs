...
[NOTE]
The Per-tenant properties mentioned below can be set by invoking the corresponding endpoints in the https://apidocs.killbill.io/invoice.html#translation[translation] and https://apidocs.killbill.io/invoice.html#template[template] sections in the API docs.
