...
* A valid JWT ID token (see link:aviate-authentication.adoc[Aviate Authentication]).
* A Kill Bill account with a default payment method (required for paid credits and top-off). See link:aviate-billing-account.adoc[Aviate Billing Accounts].
...
1. Ensure the account has a valid default payment method (see link:aviate-billing-account.adoc[Aviate Billing Accounts]).
...
* link:aviate-authentication.adoc[Aviate Authentication] — obtain the `ID_TOKEN` used in all examples above
* link:aviate-metering.adoc[Aviate Metering] — usage events that consume wallet credits
* link:aviate-usage-ai-tutorial.adoc[Usage + Wallet Tutorial] — complete end-to-end tutorial combining metering, wallets, and invoicing
* link:aviate-coupons.adoc[Aviate Coupons] — discounts vs. wallet credits
