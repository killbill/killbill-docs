...
* Tenant configurations: Properties that have been overriden on a per-tenant level
...
* Default property values: Default values if non of the above overrode the default value
