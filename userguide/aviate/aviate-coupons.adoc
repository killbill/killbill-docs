...
* At least one plan in the catalog (see link:aviate-catalog-guide.adoc[Aviate Catalog Guide]).
...
* link:aviate-billing-account.adoc[Aviate Billing Accounts] — set up accounts before creating subscriptions
* link:aviate-catalog-guide.adoc[Aviate Catalog Guide] — create the plans referenced by coupons
* link:aviate-wallet.adoc[Aviate Wallets] — wallet credits as an alternative to coupon discounts
