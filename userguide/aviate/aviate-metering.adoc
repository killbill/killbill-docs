...
* You have a valid ID token for authentication (see link:aviate-authentication.adoc[Authentication]).
* For invoicing: a catalog with a usage-based plan exists (see link:aviate-catalog-guide.adoc[Catalog Guide — Creating Usage Plans]).
...
. Create a catalog with a usage-based plan that references the meter's code (see link:aviate-catalog-guide.adoc[Catalog Guide — Creating Usage Plans]).
...
* link:aviate-authentication.adoc[Authentication] — obtaining an ID token
* link:aviate-catalog-guide.adoc[Catalog Guide] — creating usage-based plans
* link:aviate-usage-ai-tutorial.adoc[AI Usage Tutorial] — full end-to-end workflow with wallet and metering
* link:aviate-wallet.adoc[Wallet] — prepaid credits consumed by usage