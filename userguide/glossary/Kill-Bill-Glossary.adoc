...
Entitlement Start Date (Or "Entitlement Date") ::The date on which a user gains access to the underlying entitlement or service . See Also <<billing_start_date, Billing Date>>.
