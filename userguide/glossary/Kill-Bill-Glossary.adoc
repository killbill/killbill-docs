...
API:: The software intermediary that enables communication between two applications. For more information, see the https://apidocs.killbill.io/[_Kill Bill API Reference_].
